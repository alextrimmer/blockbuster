...
enum UIMenuEnums {
        DEFAULT(new UIMenuAction() {
            public void run() {
                 ...
                 _ui.displayError("Press 9 you fool.");
            }
            ...
            public void run() {
                ...
                if (!isNull) {
                    ...
                    UIFormBuilderInterface f = (UIFormBuilderInterface) uiFactory.start("Form", null, null);

                    f.add("Number of copies to add/remove", UIFormEnums.NUMBERTEST.getUIFT());
        ...
        static class EnumConstructor {
            public EnumConstructor(UI ui, Inventory inventory, UIFormMenuInterface getVideoForm, States state) {
                _ui = ui;
